...
describe('ConstructionService', () => {
  ...
  describe('updateBOQStatus', () => {
    it('should throw BadRequestException for invalid transition', async () => {
      mockPrisma.bOQ.findUnique.mockResolvedValue({
        id: 'boq-1',
        status: 'Approved',
        tenantId: 't1',
      });
      await expect(
        service.updateBOQStatus('t1', 'boq-1', 'Draft'),
    ...
    it('should update BOQ status for valid transition', async () => {
      ...
      mockPrisma.bOQ.update.mockResolvedValue({
        id: 'boq-1',
        status: 'UnderReview',
      });
      const result = await service.updateBOQStatus(
        't1',
        'boq-1',
        'UnderReview',
      );
  ...
  describe('generateRABill', () => {
    ...
    it('should complete RA billing transactions and retention schedule', async () => {
      ...
      mockPrisma.bOQ.findFirst.mockResolvedValue({
        id: 'boq-1',
        status: 'Approved',
      });
