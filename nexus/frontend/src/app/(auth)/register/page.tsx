        ...
        <Card className="bg-white border-slate-200 shadow-2xl shadow-blue-500/5 relative z-10 rounded-[2.5rem] overflow-hidden">
          <CardHeader className="p-8 pb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <Badge
                variant="outline"
                className="border-slate-100 text-slate-400 font-black text-[10px]"
              >
                Step {step} of 2
              </Badge>
            </div>
          ...
          <CardContent className="p-8 pt-4">
            {step === 1 ? (
              <form
                id="user-form"
                onSubmit={handleUserSubmit(onUserStepSubmit)}
                className="space-y-5"
              >
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-2">
                          <div
                            className={`w-4 h-4 rounded-full flex items-center justify-center ${req.valid ? "bg-green-500 text-white" : "bg-slate-200 text-slate-400"}`}
                          >
                            {req.valid && (
                          ...
                          <span
                            className={`text-[10px] font-bold uppercase tracking-tight ${req.valid ? "text-green-600" : "text-slate-400"}`}
                          >
                            {req.label}
                          </span>
                        </div>
              ...
              <form
                id="company-form"
                onSubmit={handleCompanySubmit(onFinalSubmit)}
                className="space-y-5"
              >
                <div className="space-y-2">
                  <Label
                ...
                <div className="space-y-2">
                  ...
                  {companyErrors.companyType && (
                    <p className="text-xs text-rose-500 font-bold">
                      {companyErrors.companyType.message}
                    </p>
                  )}
                </div>
              </form>
          ...
          <CardFooter className="p-8 pt-0 flex flex-col gap-4">
            <div className="flex w-full gap-3">
              ...
              <Button
                type="submit"
                form={step === 1 ? "user-form" : "company-form"}
                disabled={isLoading}
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-black h-12 rounded-xl transition-all shadow-lg shadow-blue-500/20 uppercase tracking-widest text-[10px] active:scale-95"
              >
                {isLoading ? (
                  <>
