        ...
        <Card className="w-full max-w-md bg-white border-slate-200 shadow-2xl relative z-10 rounded-[2.5rem] p-4 text-center">
          ...
          <CardFooter className="flex flex-col gap-4 pb-8">
            <Link href="/login" className="w-full">
              <Button
                variant="outline"
                className="w-full border-slate-200 text-slate-600 font-black h-12 rounded-xl uppercase tracking-widest text-[10px]"
              >
                Back to Sign In
              </Button>
            </Link>
      ...
      <Card className="w-full max-w-md bg-white border-slate-200 shadow-2xl relative z-10 rounded-[2.5rem] p-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-4 pb-8">
            ...
            <Link
              href="/login"
              className="text-[10px] flex items-center gap-2 text-slate-400 hover:text-blue-600 font-bold uppercase tracking-tighter transition-colors"
            >
              <ArrowLeft size={10} />
              Back to Sign In
            </Link>
