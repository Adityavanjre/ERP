      ...
      <div className="flex items-center justify-center min-h-screen bg-slate-50">
        <Card className="w-full max-w-md bg-white border-slate-200 shadow-2xl rounded-[2.5rem] p-4 text-center">
          <CardHeader className="space-y-4">
            <CardTitle className="text-3xl font-extrabold tracking-tight uppercase text-rose-600">
              Error
            </CardTitle>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2">
              <Label className="text-slate-500 font-bold text-[10px] uppercase tracking-widest ml-1">
                New Password
              </Label>
