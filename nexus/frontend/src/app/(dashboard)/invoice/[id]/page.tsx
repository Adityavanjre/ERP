    ...
    return (
        <div className="min-h-screen bg-slate-900 p-8 print:p-0 print:bg-white text-slate-900 print:text-black">
            ...
            <div className="max-w-4xl mx-auto mb-8 flex justify-between items-center print:hidden">
                <h1 className="text-2xl font-black text-white tracking-tighter">Invoice Preview</h1>
            ...
            <div className="max-w-4xl mx-auto bg-white p-12 shadow-2xl print:shadow-none print:w-full">
                ...
                <div className="flex justify-between items-start border-b-2 border-zinc-100 pb-8 mb-8">
                    <div>
                        <div className="text-4xl font-extrabold text-zinc-900 tracking-tight">INVOICE</div>
                        <div className="text-sm text-zinc-500 mt-1 font-medium">#{invoice.invoiceNumber}</div>
                        <div className="mt-4 space-y-1 text-sm text-zinc-600">
                            <p className="font-bold text-zinc-900">Issued To:</p>
                    ...
                    <div className="text-right">
                        <div className="text-xl font-bold text-zinc-900">Business Name Inc.</div>
                ...
                <div className="mt-16 pt-8 border-t border-zinc-100 flex justify-between items-end">
                    <div className="text-[10px] text-zinc-400 max-w-sm">
                        ...
                        <p>1. Payment is due within {Math.ceil((new Date(invoice.dueDate).getTime() - new Date(invoice.issueDate).getTime()) / (1000 * 3600 * 24))} days.</p>
                        <p>2. Please quote invoice number in all correspondence.</p>
                        <p>3. Make checks payable to "Business Name Inc".</p>
                    </div>
                    <div className="text-right">
