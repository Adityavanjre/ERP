            ...
            <Table className="min-w-[700px]">
              <TableHeader className="bg-slate-50/30">
                <TableRow className="border-slate-100 hover:bg-transparent print:border-black">
                  <TableHead className="text-slate-500 font-black text-[10px] uppercase tracking-[0.2em] pl-8 py-5">
                    Date
                  </TableHead>
                  ...
                  <TableHead className="text-right text-slate-500 font-black text-[10px] uppercase tracking-[0.2em] pr-8">
                    Balance
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                ...
                <TableRow className="border-slate-50 hover:bg-transparent print:border-zinc-200">
                  <TableCell className="pl-8 text-slate-400 text-[10px] font-black tracking-widest">
                    INIT
                  </TableCell>
                ...
                {(ledger || []).map((entry: LedgerEntry) => (
                  ...
                  >
                    <TableCell className="pl-8 text-slate-900 text-xs font-black tracking-tighter print:text-black">
