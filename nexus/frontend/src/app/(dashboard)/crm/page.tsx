  ...
  const handleUpdateDeal = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setOpportunities((prev) =>
        prev.map((o) =>
          o.id === editingDeal.id
            ? { ...editingDeal, value: Number(editingDeal.value) }
            : o,
        ),
      );
    ...
    <div className="flex-1 space-y-2 pt-1 md:pt-2 w-full max-w-full overflow-hidden">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-2 lg:gap-0">
        ...
        <div className="flex flex-wrap gap-2 w-full lg:w-auto mt-1 lg:mt-0">
          ...
          <Button
            className="flex-1 sm:flex-none justify-center rounded-2xl bg-amber-50 border border-amber-100 hover:bg-amber-100/50 text-amber-700 shadow-sm font-bold h-11 px-5 whitespace-nowrap"
            ...
            >
              <div className="md:col-span-2 space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setDealData({ ...dealData, title: e.target.value })
                  }
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setDealData({ ...dealData, customerId: v })
                  }
                >
            ...
            <form onSubmit={handleUpdateDeal} className="grid gap-2 py-2">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setEditingDeal({ ...editingDeal, stage: v })
                  }
                >
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant="secondary"
                        className="bg-slate-200 text-slate-600 font-black text-[10px] rounded-lg border-none shadow-none"
                      >
                        {stageOpps.length}
                      </Badge>
                    </div>
                    ...
                    {stageOpps.map((opp) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 mb-1.5">
                          ...
                          <span className="text-[11px] text-slate-500 font-bold uppercase tracking-tight truncate max-w-[160px]">
                ...
                <TableBody>
                  ...
                  {filteredCustomers.length === 0 && (
                    <TableRow>
                      <TableCell
                        colSpan={6}
                        className="h-48 text-center text-slate-400 font-bold italic bg-slate-50/10"
                      >
                        No customers found.
                      </TableCell>
                    </TableRow>
