    ...
    switch (status) {
      ...
      default:
        return (
          <Badge
            variant="outline"
            className="bg-slate-100 text-slate-400 font-black text-[10px] uppercase tracking-tighter rounded-lg px-3 py-1"
          >
            {status}
          </Badge>
        );
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Manage your supply chain and purchase orders.
          </p>
        </div>
                    ...
                    <CardHeader>
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Badge
                            variant="secondary"
                            className="bg-slate-100 text-slate-500 font-black text-[9px] rounded-md border-none uppercase tracking-tighter self-start"
                          >
                            {s.category}
                          </Badge>
                        </div>
