        ...
        <Card className="rounded-3xl border-slate-100 shadow-sm hover:shadow-md transition-all">
          <CardContent className="pt-3">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-rose-50 text-rose-700 hover:bg-rose-50 border-none">
                Pending
              </Badge>
            </div>
            <div className="mt-4">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm">
                {patients.map((p) => (
                  <tr
                    key={p.id}
                    className="border-t border-slate-50 hover:bg-slate-50/40 transition-all group"
                  >
                    <td className="px-6 py-4 font-mono font-bold text-blue-600 text-xs">
                      {p.id}
                    </td>
