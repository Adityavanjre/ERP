  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium tracking-tight">
              Real-time stock management and drug classification.
            </p>
          </div>
        </div>
      ...
      <div className="bg-amber-50 border border-amber-100 p-8 rounded-[2.5rem] flex items-center gap-6">
        ...
        <div>
          <h4 className="text-amber-900 font-black uppercase text-xs tracking-widest mb-1">
            Stock Warning System
          </h4>
          <p className="text-amber-800/70 text-sm font-medium leading-relaxed">
            Auto-sync with the central procurement department will trigger for
            all Low Stock and Critical items at 11:00 PM IST.
          </p>
        </div>
      </div>
    </div>
