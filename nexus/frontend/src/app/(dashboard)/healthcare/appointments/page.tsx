    ...
    <div className="space-y-8 animate-in slide-in-from-bottom duration-500">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase tracking-widest">
              Appointments
            </h1>
            <p className="text-slate-500 font-medium">
              Manage patient bookings and hospital scheduling.
            </p>
          </div>
        </div>
        ...
        <Card className="rounded-[2.5rem] border-slate-100 shadow-sm border-none bg-white p-2">
          ...
          <CardContent className="px-8 pb-8 space-y-4">
            {appointments.map((apt) => (
              <div
                key={apt.id}
                className="group p-5 rounded-3xl bg-slate-50 hover:bg-white hover:shadow-xl hover:shadow-slate-200/50 transition-all border border-transparent hover:border-slate-100 flex items-center justify-between"
              >
                <div className="flex items-center gap-4">
                  <div
                    className={cn(
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-slate-900 p-2 overflow-hidden relative">
          ...
          <CardContent className="px-8 pb-8 relative z-10 grid grid-cols-2 gap-4">
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all cursor-pointer group">
              ...
              <h4 className="text-white font-black mt-4 uppercase text-[10px] tracking-widest">
                New Patient
              </h4>
            </div>
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all cursor-pointer group">
            ...
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all cursor-pointer group col-span-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-white font-black uppercase text-[10px] tracking-widest">
                    Emergency Ward
                  </h4>
                  <p className="text-white/40 text-[9px] mt-1 font-bold">
                    CONTACT ON-CALL DOCTOR IMMEDIATELY
                  </p>
                </div>
              </div>
            </div>
