    ...
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium tracking-tight">
              Encrypted and secure clinical documentation.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="rounded-[2rem] border-slate-100 bg-emerald-50/30 border-none shadow-none p-6">
          ...
          <p className="text-sm text-emerald-700/70 mt-1 font-medium leading-relaxed">
            All medical documentation is encrypted using AES-256 before being
            stored in the cloud.
          </p>
        </Card>
        <Card className="rounded-[2rem] border-slate-100 bg-blue-50/30 border-none shadow-none p-6">
          ...
          <p className="text-sm text-blue-700/70 mt-1 font-medium leading-relaxed">
            Every access to medical records is logged with TIMESTAMP and USER ID
            for compliance.
          </p>
        </Card>
        <Card className="rounded-[2rem] border-slate-100 bg-slate-50/50 border-none shadow-none p-6">
          ...
          <p className="text-sm text-slate-700/70 mt-1 font-medium leading-relaxed">
            Our infrastructure meets global healthcare standards for data
