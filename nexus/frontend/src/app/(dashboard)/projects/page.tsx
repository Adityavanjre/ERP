      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Track and manage your projects, tasks, and team progress.
          </p>
        </div>
          ...
          <CardContent className="p-4 md:p-8">
            ...
            >
              <div className="md:col-span-2 space-y-2">
                ...
                <Input
                  className="bg-slate-50 border-slate-200 text-slate-900 rounded-xl h-11 focus:ring-blue-500/20 font-bold"
                  value={formData.name}
                  onChange={(e) =>
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                <Input
                  className="bg-slate-50 border-slate-200 text-slate-900 rounded-xl h-11 focus:ring-blue-500/20 font-medium"
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project) => {
          ...
          return (
            <Card
              key={project.id}
              className="bg-white border-slate-200 shadow-xl shadow-slate-200/20 hover:shadow-2xl hover:shadow-blue-500/10 transition-all group overflow-hidden border-none"
            >
              ...
              <CardHeader className="pb-4 bg-slate-50/50">
                ...
                <CardTitle className="text-slate-900 text-xl font-black tracking-tight">
                  {project.name}
                </CardTitle>
              ...
              <CardContent className="space-y-6 pt-6">
                <div className="space-y-2">
                  ...
                  <Progress
                    ...
                    indicatorClassName="bg-blue-600 shadow-[0_0_10px_rgba(37,99,235,0.4)]"
                  />
                </div>
                ...
                <div className="flex gap-3 pt-2">
                  <Button
                    variant="ghost"
                    className="w-full text-slate-400 hover:text-slate-600 font-bold text-[10px] uppercase tracking-widest h-10 rounded-xl"
