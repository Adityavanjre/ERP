    ...
    switch (status) {
      ...
      default:
        return (
          <Badge
            variant="outline"
            className="text-[10px] uppercase tracking-tighter rounded-lg"
          >
            {status}
          </Badge>
        );
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Create and track work orders for your production runs.
          </p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
            <div>
              ...
              <CardDescription className="text-slate-500 font-bold uppercase text-[10px] tracking-widest mt-1">
                History of all production runs
              </CardDescription>
            </div>
                ...
                >
                  ...
                  <TableCell className="text-right pr-4">
                    {wo.status !== "Completed" ? (
                      ...
                      >
                        <Button className="bg-slate-900 hover:bg-emerald-600 text-white font-bold h-9 rounded-xl px-5 text-[10px] uppercase tracking-widest shadow-lg shadow-slate-900/10">
                          Mark Complete
                        </Button>
                      </CompleteWorkOrderDialog>
                    ) : (
