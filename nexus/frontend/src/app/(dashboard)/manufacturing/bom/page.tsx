      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Define assembly structures and material requirements for finished
            goods.
          </p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
            <div>
              ...
              <CardDescription className="text-slate-500 font-bold uppercase text-[10px] tracking-widest mt-1">
                Master list of assembly recipes
              </CardDescription>
            </div>
            ...
            <TableBody>
              {filteredBoms.map((bom) => (
                ...
                >
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter">
                          BOM-{bom.id.slice(-6).toUpperCase()}
                        </div>
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <Badge
                      variant="secondary"
                      className="bg-slate-100 text-slate-500 font-black text-[10px] rounded-lg border-none uppercase"
                    >
              ...
              {filteredBoms.length === 0 && (
                <TableRow>
                  <TableCell
                    colSpan={6}
                    className="h-48 text-center text-slate-400 font-bold italic bg-slate-50/10 uppercase tracking-widest text-[10px]"
                  >
        ...
        <Card className="bg-white border-slate-200 shadow-xl shadow-slate-200/40 rounded-3xl overflow-hidden border-none">
          <CardHeader className="border-b border-slate-100">
            ...
            <CardDescription className="text-[10px] font-bold uppercase tracking-widest">
              Detailed component & sub-assembly list
            </CardDescription>
          </CardHeader>
          <CardContent className="p-0">
            {detailsLoading ? (
              ...
              <Table>
                <TableHeader>
                  <TableRow className="hover:bg-transparent border-slate-100">
                    <TableHead className="text-[9px] uppercase font-bold pl-6">
                      Material
                    </TableHead>
                    <TableHead className="text-[9px] uppercase font-bold text-right pr-6">
                      Quantity
                    </TableHead>
                  </TableRow>
                </TableHeader>
              ...
              <div className="p-12 flex flex-col items-center justify-center text-center space-y-4">
                ...
                <p className="text-sm font-bold text-slate-600">
                  Select a BOM to see recursive material requirements including
                  sub-assemblies.
                </p>
              </div>
            )}
            ...
            {detailsLoading ? (
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center bg-white/5 p-4 rounded-2xl border border-white/10">
                  ...
                  <span className="text-2xl font-black">
                    ₹{costAnalysis.materialCost.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between items-center bg-emerald-500/10 p-4 rounded-2xl border border-emerald-500/20">
                  ...
                  <span className="text-2xl font-black text-emerald-400">
                    ₹{costAnalysis.estimatedUnitCost.toLocaleString()}
                  </span>
                </div>
                <div className="pt-2">
              ...
              <div className="flex flex-col items-center justify-center text-center space-y-4">
                ...
                <p className="text-sm font-bold text-slate-400">
                  Select a BOM to calculate total production cost based on
