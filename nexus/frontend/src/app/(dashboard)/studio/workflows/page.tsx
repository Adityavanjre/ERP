      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">
            Design state machines and automation logic for enterprise objects.
          </p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 border-t border-slate-100 space-y-2">
              ...
              <Button
                ...
                className="w-full bg-slate-900 hover:bg-black text-white h-9 font-bold uppercase tracking-widest text-[10px]"
              >
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
                <Button
                  ...
                  variant="outline"
                  className="w-full sm:w-auto border-slate-200 bg-white text-slate-600 font-bold hover:bg-slate-50"
                >
                    ...
                    <CardContent className="px-6 pb-6 pt-0">
                      <div className="space-y-3">
                        <div className="p-3 rounded-xl bg-white/5 border border-white/5 flex items-center justify-between group-hover:border-emerald-500/30 transition-all">
                          ...
                          <span className="text-[9px] text-slate-500 font-black uppercase hover:text-white cursor-pointer transition-colors">
                            Script
                          </span>
                        </div>
                        <Button
                          variant="ghost"
                          className="w-full justify-start text-[10px] h-9 text-emerald-400 font-black uppercase tracking-widest hover:bg-emerald-500/10 rounded-xl transition-all"
                        >
              ...
              <div className="flex items-center gap-6 text-[10px] font-black tracking-widest uppercase flex-wrap">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-500">
                    States: {selectedWorkflow?.nodes?.length || 0}
                  </span>
                </div>
                <div className="flex items-center gap-2">
