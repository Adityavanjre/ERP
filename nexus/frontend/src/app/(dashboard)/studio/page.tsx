...
export default function StudioPage() {
  ...
  const updateField = useCallback(
    (index: number, key: keyof StudioField, value: string | boolean) => {
      setFields((prev) => {
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
        <div>
          ...
          <p className="text-slate-500 mt-1 font-medium">
            Design custom business objects and automated workflows without code.
          </p>
        </div>
        ...
        <Card className="bg-white border-slate-200 shadow-xl shadow-slate-200/40 rounded-3xl lg:col-span-2 overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between bg-slate-50 border-b border-slate-100">
            ...
            <Button
              onClick={addField}
              variant="outline"
              className="border-fuchsia-200 text-fuchsia-600 bg-fuchsia-50 hover:bg-fuchsia-100 font-bold rounded-xl"
            >
            ...
            {["Admin", "Manager", "Employee", "Viewer"].map((role) => (
              ...
              >
                ...
                <div className="flex gap-1">
                  <div className="h-6 w-6 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center text-[10px] font-black border border-emerald-200">
                    R
                  </div>
                  <div className="h-6 w-6 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center text-[10px] font-black border border-emerald-200">
                    W
