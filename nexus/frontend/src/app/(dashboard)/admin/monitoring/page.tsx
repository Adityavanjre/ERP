        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end px-2 gap-4 sm:gap-0">
            <div>
              ...
              <p className="text-slate-400 font-bold uppercase text-[10px] tracking-widest mt-2 ml-11">
        ...
        <div className="space-y-8">
          ...
          <Card className="bg-slate-900 border-none rounded-[3rem] p-10 h-[700px] overflow-y-auto space-y-10 shadow-2xl shadow-slate-900/20">
            {data.allReports
              ...
              .map((item: SignalFeedItem, i: number) => (
                <div
                  key={i}
                  className="relative pl-8 border-l-2 border-slate-800 group"
                >
                  <div
                    className={`absolute left-[-6px] top-1.5 w-3 h-3 rounded-full ${item.status === "RED" ? "bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]" : "bg-amber-500"}`}
                  ></div>
