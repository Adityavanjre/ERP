    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium tracking-tight">
            Project site monitoring, material management, and sub-contractor
            oversight.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white border-slate-200 shadow-xl rounded-[2rem] overflow-hidden">
          <CardHeader className="p-8 pb-4">
            ...
            <CardDescription>
              Major project project sites currently in progress.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="bg-white border-slate-200 shadow-xl rounded-[2rem] overflow-hidden">
          <CardHeader className="p-8 pb-4">
            ...
            <CardDescription>
              Physical inventory currently deployed to sites.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8 pt-0">
        ...
        <Card className="bg-slate-900 border-none shadow-2xl rounded-[2rem] overflow-hidden flex flex-col justify-between">
          <div className="p-8">
            ...
            <p className="text-slate-400 text-sm mt-2 font-medium">
              Auto-sync with site biometric logs active.
            </p>
          </div>
      ...
      <div className="p-12 border-2 border-dashed border-slate-200 rounded-[3rem] text-center space-y-4">
        ...
        <p className="max-w-md mx-auto text-slate-500 font-medium">
          This industry-specific stream is currently syncing operational data.
          Full site telemetry and biometric integrations will be activated once
          the project registry is synchronized.
        </p>
      </div>
    </div>
  );
