    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium tracking-tight">
            Managing sub-contractor profiles, active contracts, and labor
            strength.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white border-slate-200 shadow-xl rounded-[2rem] overflow-hidden">
          <CardHeader className="p-8 pb-4">
            ...
            <CardDescription>
              Major sub-contractors on active site rotations.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="bg-white border-slate-200 shadow-xl rounded-[2rem] overflow-hidden">
          <CardHeader className="p-8 pb-4">
            ...
            <CardDescription>
              Estimated cumulative manpower on site today.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8 pt-0">
        ...
        <Card className="bg-slate-900 border-none shadow-2xl rounded-[2rem] overflow-hidden flex flex-col justify-between">
          <div className="p-8">
            ...
            <p className="text-slate-400 text-sm mt-2 font-medium">
              Automatic verification of insurance and licenses active.
            </p>
          </div>
        </Card>
      </div>
      ...
      <div className="p-12 border-2 border-dashed border-slate-200 rounded-[3rem] text-center space-y-4">
        ...
        <h3 className="text-xl font-black text-slate-900">
          Vendor Registry Certified
        </h3>
        <p className="max-w-md mx-auto text-slate-500 font-medium">
          This module is currently syncing with the master procurement ledger.
          Full biometric labor logs will be visible once site endpoints are
          finalized.
        </p>
      </div>
    </div>
