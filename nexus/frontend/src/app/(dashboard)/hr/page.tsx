            ...
            <DialogContent className="sm:max-w-lg">
              <DialogHeader>
                <DialogTitle className="flex items-center gap-2">
                  <Users className="h-5 w-5 text-blue-600" /> New Employee
                </DialogTitle>
                <DialogDescription>
          ...
          <Card className="bg-white border-slate-200 shadow-xl shadow-slate-200/40 rounded-3xl overflow-hidden border-none">
            <CardHeader className="bg-slate-50 border-b border-slate-100 py-6 px-4 md:px-8">
              ...
              <CardDescription className="text-slate-500 font-bold uppercase text-[10px] tracking-widest mt-1">
                Master database of all employees
              </CardDescription>
            </CardHeader>
              ...
              <Table className="min-w-[800px]">
                ...
                <TableBody>
                  {(employees || []).map((emp) => (
                    ...
                    >
                      <TableCell className="font-black text-[10px] text-blue-600 tracking-widest pl-8 bg-slate-50/30">
                        #
                        {emp.employeeId
                      ...
                      <TableCell className="text-right pr-8">
                        <Badge
                          className={
                            emp.status === "Active"
                              ? "bg-emerald-50 text-emerald-600 border-none font-black text-[10px] uppercase"
                              : "bg-slate-100 text-slate-400 border-none font-black text-[10px] uppercase"
                          }
                        >
                          {emp.status}
                        </Badge>
            ...
            <CardHeader className="bg-slate-50 border-b border-slate-100 py-6 px-4 md:px-8">
              <div className="flex justify-between items-center w-full">
                <div>
                  ...
                  <CardDescription className="text-slate-500 font-bold uppercase text-[10px] tracking-widest mt-1">
                    Structural mapping of business departments
                  </CardDescription>
                </div>
                  ...
                  departments.map((dept) => (
                    ...
                    >
                      <CardHeader className="pb-6">
                        ...
                        <CardDescription className="text-blue-600 font-bold uppercase text-[10px] tracking-widest mt-1">
                          {dept._count.employees} team members networked
                        </CardDescription>
                      </CardHeader>
                    </Card>
                  ))}
        ...
        <TabsContent value="leaves">
          <Card className="bg-white border-slate-200 shadow-xl shadow-slate-200/40 rounded-3xl overflow-hidden border-none">
            <CardHeader className="bg-slate-50 border-b border-slate-100 py-6 px-4 md:px-8">
              ...
              <CardDescription className="text-slate-500 font-bold uppercase text-[10px] tracking-widest mt-1">
                Personnel leave requests and availability tracking
              </CardDescription>
            </CardHeader>
            <CardContent className="p-0 overflow-x-auto max-w-[100vw] sm:max-w-none">
              <Table className="min-w-[800px]">
                ...
                <TableBody>
                  {(leaves || []).map((leave) => (
                    <TableRow
                      ...
                      className="border-slate-100 hover:bg-slate-50/50 transition-all group"
                    >
                      <TableCell className="pl-8 font-black text-slate-900 tracking-tight">
                            ...
                            className={
                              leave.status === "Approved"
                                ...
                                : leave.status === "Pending"
                                  ? "bg-amber-50 text-amber-600 border-none font-black text-[10px] uppercase"
                                  : "bg-rose-50 text-rose-600 border-none font-black text-[10px] uppercase"
                            }
                          >
                            {leave.status}
                          </Badge>
        ...
        <TabsContent value="payroll">
          <Card className="bg-white border-slate-200 shadow-xl shadow-slate-200/40 rounded-3xl overflow-hidden border-none">
            <CardHeader className="bg-slate-50 border-b border-slate-100 py-6 px-4 md:px-8">
              ...
              <CardDescription className="text-slate-500 font-bold uppercase text-[10px] tracking-widest mt-1">
                Disbursement history and financial personnel mapping
              </CardDescription>
            </CardHeader>
            <CardContent className="p-0 overflow-x-auto max-w-[100vw] sm:max-w-none">
              <Table className="min-w-[800px]">
