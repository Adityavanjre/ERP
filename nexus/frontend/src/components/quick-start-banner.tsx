  ...
  const steps = [
    {
      ...
      description: "Click through all main tabs to get familiar",
    },
    {
      id: 2,
      title: "Create Your First Invoice",
      description: "Go to Finance → Issue Invoice",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description: "Set up your actual inventory items",
    },
    {
      id: 5,
          ...
          return (
            ...
            >
              ...
              <div className="flex-1">
                <div
                  className={`font-bold ${isCompleted ? "text-emerald-900 line-through" : "text-slate-900"}`}
                >
                  {step.title}
                </div>
