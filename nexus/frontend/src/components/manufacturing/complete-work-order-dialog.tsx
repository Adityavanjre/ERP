        ...
        <div className="grid gap-3 py-3">
          <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 mb-2">
            ...
            <div className="font-medium text-slate-900">
              {workOrder.bom?.product?.name}
            </div>
            <div className="text-xs text-slate-500 mt-1">
              Target Quantity: {workOrder.quantity} Units
            </div>
          </div>

          <div className="grid gap-2">
            <Label
              htmlFor="producedQuantity"
            ...
            <p className="text-[10px] text-slate-500 mt-1">
              The actual amount of finished goods moving to inventory.
            </p>
          </div>
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-[10px] text-slate-500 mt-1">
              Materials consumed but did not result in finished goods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="grid gap-2">
              <Label className="text-slate-700 font-bold text-xs uppercase">
                Run Time (Hrs)
              </Label>
              <Input
                type="number"
          ...
          <div className="grid gap-2">
            ...
            <p className="text-[10px] text-slate-500 mt-1">
              Finished goods will be added to this inventory location.
            </p>
          </div>
