        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-3 py-2 text-[10px] font-black text-slate-500 uppercase tracking-wider text-center w-32">Qty</th>
          ...
          <tbody className="divide-y divide-slate-100">
            ...
            {items.map((item, idx) => (
              ...
              <td className="px-3 py-2 text-right">
                <p className="text-sm font-bold text-slate-600 tabular-nums">₹{item.price.toFixed(2)}</p>
              </td>
              <td className="px-3 py-2 text-right relative">
                <p className="text-base font-black text-slate-900 tabular-nums">₹{(item.price * item.quantity).toFixed(2)}</p>
                <button
