  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-11/12 sm:min-w-fit sm:max-w-[700px] rounded-[3rem] border-none shadow-2xl p-0 overflow-hidden">
        <div className="bg-slate-900 p-2.5 text-white relative">
          ...
          <DialogHeader className="relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-3 mt-2 pt-3 border-t border-white/10">
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-slate-100 hover:bg-transparent">
                    <TableHead className="text-slate-500 font-bold uppercase text-[9px] tracking-widest pl-6">
                      Product
                    </TableHead>
                    <TableHead className="text-slate-500 font-bold uppercase text-[9px] tracking-widest">
                      SKU
                    </TableHead>
                    <TableHead className="text-slate-500 font-bold uppercase text-[9px] tracking-widest text-right pr-6">
                      In-Hand Stock
                    </TableHead>
                  </TableRow>
                </TableHeader>
