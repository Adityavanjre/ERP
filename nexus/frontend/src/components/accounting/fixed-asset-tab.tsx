        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription className="text-slate-500 font-medium">
              Manage long-term assets and automated depreciation.
            </CardDescription>
          </div>
        ...
        <Table>
          <TableHeader className="bg-slate-50/50">
            <TableRow className="hover:bg-transparent border-slate-100">
              <TableHead className="font-bold text-slate-900 px-3 h-12">
                Asset
              </TableHead>
              <TableHead className="font-bold text-slate-900 px-3 h-12">
                Type
              ...
              <TableHead className="text-right px-3 h-12">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {assets.map((asset) => (
              ...
              >
                ...
                <TableCell className="px-3 py-3 font-bold text-slate-600">
                  {asset.type}
                </TableCell>
                <TableCell className="px-3 py-3 font-black text-slate-900">
                  ₹{Number(asset.purchaseValue).toLocaleString()}
                </TableCell>
                <TableCell className="px-3 py-3 font-bold text-rose-500">
                  -₹{Number(asset.accumulatedDepreciation).toLocaleString()}
                </TableCell>
                <TableCell className="px-3 py-3 font-black text-emerald-600">
                  ₹
                  {(
