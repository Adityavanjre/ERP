    ...
    <Card className="border-amber-200/50 bg-amber-50/10 backdrop-blur-sm">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          ...
          <Badge
            variant="outline"
            className="bg-amber-100 text-amber-700 animate-pulse border-amber-200"
          >
            30-Day Forecast
          </Badge>
        </div>
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-2xl bg-white border border-amber-100 shadow-sm">
            ...
            <div className="text-2xl font-black text-slate-900">
              {data.avgSettlementDays || 18.5} Days
            </div>
            ...
            >
              ...
              <div className="text-right">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Progress
                    value={proj.probability}
                    className="h-1 w-12 bg-slate-100 placeholder:bg-slate-200"
                  />
                  <span className="text-[9px] font-black text-amber-600">
                    {proj.probability}% Confidence
                  </span>
                </div>
              </div>
            </motion.div>
