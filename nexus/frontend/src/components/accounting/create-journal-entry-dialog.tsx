    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-11/12 sm:min-w-fit sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Record a manual journal entry. Every debit must have an equal credit
            (double-entry bookkeeping). Use this for corrections, adjustments,
            or transactions not covered by invoices/payments.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-1">
              ...
              {!isBalanced && totalDebits > 0 && totalCredits > 0 && (
                <div className="text-sm text-red-600 bg-red-50 p-2 rounded">
                  ⚠️ Entry is not balanced. Difference: ₹
