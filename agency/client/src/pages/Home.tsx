...
import { ArrowRight, Crown, Zap, Globe } from "lucide-react";
    ...
    <div className="py-16 border-y border-white/5 bg-black/40 overflow-hidden select-none">
      <div className="flex whitespace-nowrap animate-infinite-scroll">
        {[...brands, ...brands].map((brand, i) => (
          <span
            key={i}
            className="mx-16 text-xs font-black text-white/5 hover:text-[#C5A059]/40 transition-all tracking-[0.5em]"
          >
            {brand}
          </span>
        ))}
...
const Home = () => {
  ...
  return (
    <div className="bg-[#0A0A0B] text-white">
      ...
      <section
        ref={heroRef}
        className="min-h-screen relative flex flex-col items-center justify-center p-8 pt-32 overflow-hidden"
      >
        ...
        >
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-xl md:text-2xl text-zinc-400 font-medium leading-relaxed mb-16 tracking-tight">
              ...
              <span className="text-white">luxury brand identities</span> for
              those who refuse to blend in. Custom web design meets
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            <Link to="/contact" className="btn-lux group px-12 h-16 text-black">
              ...
              <div className="ml-4 w-6 h-6 rounded-full bg-black flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-transform">
                <ArrowRight size={14} className="text-[#C5A059]" />
              </div>
            </Link>
            <Link
              to="/portfolio"
              className="btn-lux-outline px-12 h-16 border-white/5 hover:bg-white/5 transition-all"
            >
              View Our Work
            </Link>
          </div>
        ...
        <div className="absolute bottom-20 left-8 md:left-20 flex flex-col gap-6 opacity-40">
          ...
          <p className="vertical-text text-[9px] font-black uppercase tracking-[0.4em] text-[#C5A059]">
            Agency • Bengaluru
          </p>
        </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-32">
            <div className="max-w-xl">
              <p className="text-[#C5A059] font-black tracking-[0.3em] uppercase text-[10px] mb-6">
                Our Services
              </p>
              <h2 className="text-5xl md:text-8xl font-bold tracking-tighter leading-[0.9] font-heading">
                Digital <br />
                <span className="text-zinc-700 italic font-display font-medium">
                  Excellence.
                </span>
              </h2>
            </div>
            <p className="text-zinc-500 max-w-xs text-sm font-medium mt-8 md:mt-0 leading-loose border-l border-[#C5A059]/20 pl-8">
              We operate at the intersection of sophisticated design and robust
              engineering. No shortcuts, just pure performance.
            </p>
          </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center mb-40">
            <div className="space-y-12">
              <div>
                <h3 className="text-[#C5A059] font-black tracking-[0.4em] uppercase text-[10px] mb-8">
                  Selected Case Study
                </h3>
                <h2 className="text-5xl md:text-8xl font-bold tracking-tighter leading-none font-heading mb-10">
                  Modern <br />
                  <span className="italic font-display font-medium">
                    Websites.
                  </span>
                </h2>
                <p className="text-zinc-400 text-lg font-medium leading-relaxed max-w-lg mb-12">
                  We redesigned the digital presence for high-growth ventures,
                  increasing engagement through intentional design and technical
                  superiority.
                </p>
                <Link
                  to="/portfolio"
                  className="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.3em] text-white hover:text-[#C5A059] transition-colors group"
                >
                  View Full Case Study{" "}
                  <div className="p-2 rounded-full border border-white/10 group-hover:border-[#C5A059] group-hover:bg-[#C5A059] group-hover:text-black transition-all">
                    <ArrowRight size={14} />
                  </div>
                </Link>
              </div>
            ...
            <div className="relative group p-4 border border-white/5 rounded-[4rem]">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#C5A059] rounded-3xl flex flex-col items-center justify-center rotate-6 group-hover:rotate-0 transition-all duration-500 shadow-2xl">
                <span className="text-black font-black text-3xl font-heading">
                  40%
                </span>
                <span className="text-black font-black text-[8px] uppercase tracking-widest">
                  Growth
                </span>
              </div>
            </div>
      ...
      {/* Klypso Nexus - Enterprise Ecosystem */}
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1 relative">
              <div className="p-4 border border-white/5 rounded-[4rem] bg-black/40 backdrop-blur-xl shadow-3xl">
                <div className="aspect-[16/10] rounded-[3rem] overflow-hidden bg-zinc-900 flex items-center justify-center p-8 border border-white/5">
                  <div className="w-full h-full border border-white/5 rounded-2xl bg-black/40 p-10 flex flex-col justify-between">
                    <div className="flex justify-between items-start">
                      <div className="w-12 h-12 bg-[#C5A059] rounded-xl flex items-center justify-center font-black text-black text-2xl shadow-lg">
                        K
                      </div>
                      <div className="flex gap-2">
                        <div className="w-8 h-2 bg-[#C5A059]/40 rounded-full" />
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="w-1/2 h-4 bg-[#C5A059]/10 rounded-full" />
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="aspect-square bg-white/5 rounded-2xl" />
                      <div className="aspect-square bg-[#C5A059]/20 rounded-2xl" />
                      <div className="aspect-square bg-white/5 rounded-2xl" />
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute -top-10 -right-10 w-44 h-44 border border-white/5 bg-black/80 backdrop-blur-3xl rounded-full flex flex-col items-center justify-center p-8 text-center rotate-12 group-hover:rotate-0 transition-transform duration-700 shadow-3xl">
                <span className="text-[#C5A059] text-xs font-black uppercase tracking-tighter mb-2">
                  Internal Tool
                </span>
                <span className="text-white text-xl font-bold font-heading leading-tight uppercase">
                  Nexus <br /> Platform
                </span>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 space-y-12">
              <div>
                <p className="text-[#C5A059] font-black tracking-[0.4em] uppercase text-[10px] mb-8">
                  Technology
                </p>
                <h2 className="text-5xl md:text-8xl font-bold tracking-tighter leading-[0.9] font-heading mb-10">
                  Enterprise <br />
                  <span className="italic font-display font-medium text-zinc-600">
                    Operations.
                  </span>
                </h2>
                <p className="text-zinc-400 text-lg font-medium leading-relaxed mb-12">
                  Elite brands require more than just a website. We deploy
                  **Klypso Nexus**, a custom business tool that centralizes your
                  global operations, finances, and client intelligence into one
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10">
              ...
              <p className="text-zinc-500 uppercase text-[9px] font-black tracking-[0.5em] max-w-xs text-left leading-relaxed">
                We partner with a limited number of clients to ensure <br />{" "}
...
const FeatureCard = ({
  ...
  >
    <Link
      to="/services"
      className="group relative p-10 rounded-[2rem] border border-transparent hover:border-white/5 hover:bg-white/[0.01] transition-all duration-500 block"
    >
...
const EliteStat = ({
  ...
  >
    <h4 className="text-5xl md:text-7xl font-bold text-white mb-2 tracking-tighter font-heading">
      {value}
      <span className="text-lg font-light text-[#C5A059] ml-1">{unit}</span>
    </h4>
