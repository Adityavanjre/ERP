      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-xl md:text-2xl text-zinc-500 font-medium leading-relaxed tracking-tight underline-offset-8">
            We specialize in{" "}
            <span className="text-white">expert web development</span> and{" "}
            <span className="text-white">strategic design</span>. From custom
            web systems to visual storytelling, we build the foundations for
        ...
        <div className="mb-60">
          <div className="flex flex-col md:flex-row justify-between items-end mb-32 border-b border-white/5 pb-16">
            <h2 className="text-4xl md:text-8xl font-bold tracking-tighter leading-none font-heading">
              Our <br />
              <span className="font-display italic font-light text-[#C5A059]">
                Process.
              </span>
            </h2>
            <p className="text-zinc-600 max-w-xs text-xs font-black uppercase tracking-[0.3em] mt-10 md:mt-0">
              The Road to Success
            </p>
          </div>
        ...
        <div className="relative p-12 md:p-32 rounded-[4rem] bg-[#121214] border border-white/5 overflow-hidden text-center flex flex-col items-center">
          ...
          <h2 className="text-5xl md:text-8xl font-bold mb-12 tracking-tight font-heading leading-none">
            Ready to <br />
            <span className="font-display italic font-light text-[#C5A059]">
              Start?
            </span>
          ...
          <p className="text-zinc-400 text-lg md:text-xl font-medium max-w-2xl mb-16 leading-relaxed">
            Join an ambitious list of clients who refuse to compromise on
            quality and innovation. Let's build something exceptional.
          </p>
...
const ServiceDetailCard = ({
  ...
  >
    <div className="w-20 h-20 rounded-3xl bg-white/[0.01] border border-white/5 flex items-center justify-center mb-12 group-hover:bg-[#C5A059]/10 group-hover:border-[#C5A059]/30 transition-all duration-700 shadow-xl group-hover:rotate-6">
      <div className="text-[#C5A059] group-hover:scale-110 transition-transform duration-700">
        {icon}
      </div>
    </div>
    <h3 className="text-3xl font-bold mb-6 tracking-tight text-white font-heading">
      {title}
    </h3>
    ...
    <ul className="space-y-6 border-t border-white/5 pt-10">
      {features.map((feature: string, idx: number) => (
        <li
          key={idx}
          className="flex items-center text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400"
        >
...
const ProcessRow = ({
  ...
  >
    ...
    <div className="flex-1 text-center md:text-left">
      ...
      <p className="text-zinc-500 text-lg font-medium leading-relaxed max-w-4xl">
        {desc}
      </p>
    </div>
