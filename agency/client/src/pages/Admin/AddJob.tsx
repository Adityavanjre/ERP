            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {requirements.map((req, idx) => (
                  <div
                    key={idx}
                    className="bg-pink-500/10 border border-pink-500/20 text-pink-300 px-3 py-1.5 rounded-lg text-xs flex items-center gap-2 group"
                  >
                    {req}
                    <button
                      type="button"
                      onClick={() => removeRequirement(idx)}
                      className="text-pink-500/50 hover:text-pink-400 transition-colors"
                    >
                      <X size={14} />
                    </button>
                  </div>
