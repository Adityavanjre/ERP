      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
        <div>
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-white mb-3 font-heading">
            Imperial{" "}
            <span className="text-[#C5A059] italic font-display font-medium">
              Nexus
            </span>
          </h1>
          <p className="text-zinc-500 text-sm font-medium tracking-wide">
            Command center for Klypso digital operations.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
        ...
        <div className="xl:col-span-8 space-y-10">
          <div className="bg-[#121214] border border-white/5 rounded-[2.5rem] overflow-hidden group shadow-2xl">
            <div className="p-8 border-b border-white/5 flex items-center justify-between bg-black/20">
              <div>
                <h3 className="font-bold text-lg flex items-center gap-3 font-heading">
                  <TrendingUp size={20} className="text-[#C5A059]" /> Growth
                  Trajectory
                </h3>
                <p className="text-[10px] text-zinc-600 font-black uppercase tracking-widest mt-1">
                  Market Performance Delta
                </p>
              </div>
              <div className="flex gap-2">
                <button className="px-5 py-2 text-[10px] font-black uppercase tracking-widest bg-[#C5A059] text-black rounded-xl">
                  Yearly
                </button>
              ...
              {[40, 65, 35, 90, 50, 85, 75, 95, 45, 70, 80, 100].map((h, i) => (
                ...
                >
                  <div className="w-full relative h-full flex items-end">
                    ...
                    >
                      {h > 80 && (
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-full mb-2 opacity-0 group-hover/bar:opacity-100 transition-opacity text-[9px] font-black text-[#C5A059]">
                          PEAK
                        </div>
                      )}
                    </motion.div>
                  </div>
                  <span className="text-[9px] font-black text-zinc-700 uppercase tracking-tighter transition-colors group-hover/bar:text-white">
                    {
                      [
                        "J",
                        "F",
          ...
          <div className="bg-[#121214] border border-white/5 rounded-[2.5rem] overflow-hidden shadow-2xl">
            <div className="p-8 border-b border-white/5 flex items-center justify-between bg-black/20">
              <h3 className="font-bold text-lg flex items-center gap-3 font-heading">
                <Send size={20} className="text-[#7C3AED]" /> Live Pipeline
              </h3>
              <Link
                to="/admin/enquiries"
                className="text-[10px] font-black uppercase tracking-[0.2em] text-[#C5A059] flex items-center gap-2 hover:opacity-70 transition-opacity"
              >
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-black/40">
                    <th className="px-4 sm:px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] text-zinc-600">
                      Client Node
                    </th>
                    <th className="px-4 sm:px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] text-zinc-600">
                      Classification
                    ...
                    <th className="px-4 sm:px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] text-zinc-600 text-right">
                      Action
                    </th>
                  </tr>
                </thead>
                    ...
                    >
                      <td className="px-4 sm:px-8 py-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-zinc-500 font-medium tracking-tight italic opacity-60">
                              {enq.email}
                            </p>
                          </div>
                        </div>
                      ...
                      <td className="px-4 sm:px-8 py-6">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[9px] text-zinc-700 font-medium uppercase tracking-widest">
                      ...
                      <td className="px-4 sm:px-8 py-6 text-right">
                        <Link
                          to="/admin/enquiries"
                          className="p-3 bg-white/5 rounded-xl text-zinc-500 hover:text-white hover:bg-white/10 transition-all inline-block"
                        >
        ...
        <div className="xl:col-span-4 space-y-10">
          ...
          <div className="bg-gradient-to-br from-[#C5A059] to-[#8C6D31] rounded-[2.5rem] p-10 shadow-3xl shadow-[#C5A059]/10 text-black group relative overflow-hidden">
            ...
            <Crown
              className="mb-6 opacity-30 group-hover:scale-110 transition-transform"
              size={40}
            />
            <h4 className="text-2xl font-bold tracking-tight mb-3 font-heading">
              Executive Drive
            </h4>
            <p className="text-xs font-semibold leading-relaxed mb-8 opacity-80 uppercase tracking-wide">
              3 Enterprise positions require your approval as Lead Architect.
            </p>
            <Link
              to="/admin/careers"
              className="bg-black text-white h-14 w-full rounded-2xl text-[11px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 hover:bg-zinc-900 transition-all shadow-xl"
            >
          ...
          <div className="bg-[#121214] border border-white/5 rounded-[2.5rem] p-4 font-sans">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-600 px-6 py-4">
              Direct Commands
            </p>
            <ActionLink
              icon={<Plus size={18} />}
    ...
    <div className="relative z-10">
      <div className="flex justify-between items-start mb-10">
        <div
          ...
          className={`p-4 rounded-2xl border transition-all duration-700 group-hover:scale-110 group-hover:rotate-6`}
        >
          {icon}
        </div>
      ...
      <h3 className="text-5xl font-bold text-white tracking-tighter mb-2 group-hover:scale-105 transition-transform origin-left font-heading">
        {value}
      </h3>
      ...
      <p className="text-[10px] font-bold text-zinc-600 italic tracking-tight">
        {trend}
      </p>
    </div>
  </div>
...
const ActionLink = ({ icon, label, to, color }: ActionLinkProps) => (
  <Link
    to={to}
    className="flex items-center justify-between p-4 rounded-2xl hover:bg-white/[0.04] transition-all group border border-transparent hover:border-white/5"
  >
    <div className="flex items-center gap-4">
    ...
    <ChevronRight
      size={14}
      className="opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all text-zinc-700"
    />
  </Link>
);
