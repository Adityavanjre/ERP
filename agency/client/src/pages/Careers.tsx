      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-xl md:text-2xl text-zinc-500 font-medium leading-relaxed tracking-tight underline underline-offset-4 decoration-[#C5A059]/20">
            We are a specialized agency of designers and engineers. We value{" "}
            <span className="text-white">
              craftsmanship, autonomy, and continuous growth.
            </span>
          </p>
        </motion.div>
        ...
        <div className="bg-[#121214] border border-white/5 rounded-[3rem] p-12 md:p-20 mb-40 shadow-3xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-white/5 pb-12">
            ...
            <span className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mt-6 md:mt-0">
              Uptime: 99.9%
            </span>
          </div>
            ...
            {loading ? (
              Array(3)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className="h-32 bg-white/[0.02] animate-pulse rounded-2xl"
                  />
                ))
            ) : jobs.length > 0 ? (
              jobs.map((job) => (
              ...
              <div className="py-20 text-center border border-dashed border-white/5 rounded-3xl">
                <p className="text-zinc-600 font-medium italic">
                  No active openings. Check back later for new opportunities.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="text-center relative p-16 md:p-32 rounded-[4rem] bg-gradient-to-br from-[#121214] to-black border border-white/5 overflow-hidden">
          ...
          <h3 className="text-5xl md:text-8xl font-bold mb-10 tracking-tight font-heading leading-none">
            General <br />
            <span className="font-display italic font-light text-[#C5A059]">
              Application.
            </span>
          ...
          <p className="text-zinc-400 text-lg md:text-xl mb-16 max-w-2xl mx-auto leading-relaxed">
            Don't see a role that fits? if you are a master of your craft, we'd
...
const JobCard = ({
  ...
  <div className="group flex flex-col md:flex-row md:items-center justify-between p-10 bg-black/40 rounded-3xl border border-white/5 hover:border-[#C5A059]/30 transition-all duration-700 cursor-pointer shadow-2xl">
    <div className="space-y-4">
      <h3 className="text-2xl font-bold text-white group-hover:text-[#C5A059] transition-colors font-heading">
        {role}
      </h3>
      <div className="flex gap-8 text-[9px] font-black uppercase tracking-widest text-zinc-600">
        <span className="flex items-center gap-2">
          <Clock size={12} className="text-[#C5A059]" /> {type}
        </span>
        <span className="flex items-center gap-2">
    ...
    <div className="mt-8 md:mt-0">
      <Link to="/apply" className="btn-lux px-8 h-12 text-[10px]">
        Send Application
      </Link>
    </div>
  </div>
