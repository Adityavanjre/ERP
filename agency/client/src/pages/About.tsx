  ...
  return (
    <section className="min-h-screen bg-[#0A0A0B] text-white pt-48 pb-32 px-4 relative overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Inside the private digital agency crafting digital solutions for the world's most ambitious brands."
        />
      </Helmet>
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <p className="max-w-4xl mx-auto text-xl md:text-2xl text-zinc-500 font-medium leading-relaxed tracking-tight">
            Klypso is a specialized digital agency born from a passion for
            detail. We partner with ambitious brands to build{" "}
            <span className="text-white">superior web systems</span> and{" "}
            <span className="text-white">visual identities</span> that define
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-60">
          ...
          >
            ...
            <h2 className="text-4xl font-bold mb-8 tracking-tight font-heading">
              Quality Without Compromise
            </h2>
            <p className="text-zinc-500 leading-relaxed text-lg font-medium">
              We believe that every pixel and every line of code should serve a
              purpose. Our design philosophy is simple: create digital
              experiences that are as functional as they are beautiful, ensuring
          ...
          >
            ...
            <p className="text-zinc-500 leading-relaxed text-lg font-medium">
              Performance, security, and scalability are at the core of our
              engineering. We build resilient digital ecosystems using modern
              technologies like the MERN stack, ensuring your brand is prepared
              for the future.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-32 items-center mb-60">
          <div className="space-y-12">
            <h2 className="text-5xl md:text-8xl font-bold tracking-tighter leading-none font-heading">
              A Partnership <br />
              <span className="font-display italic font-light text-[#C5A059]">
                Built to Last.
              </span>
            ...
            <div className="space-y-8 text-zinc-400 text-lg font-medium leading-relaxed">
              <p>
                Founded in 2024, Klypso was established to provide a more
                intentional alternative to high-volume, template-based agencies.
                We chose to focus on high-end craft, delivering bespoke
                solutions that prioritize quality over quantity.
              </p>
              <p>
                We operate as a dedicated team for each of our clients. By
                limiting the number of projects we take on, we ensure that every
                partnership receives our full creative and technical attention,
              ...
              <div className="pt-12 flex items-center gap-8">
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-[0.4em] text-[#C5A059]">
                    Global Projects
                  </span>
                </div>
        ...
        <div className="relative p-12 md:p-32 rounded-[4rem] bg-[#121214] border border-white/5 overflow-hidden mb-60">
          ...
          <h2 className="text-4xl md:text-7xl font-bold mb-24 text-center font-heading tracking-tight underline underline-offset-8 decoration-[#C5A059]/30">
            Our Values
          </h2>
          <div className="grid md:grid-cols-4 gap-16">
            <ProcessStep
              number="01"
              title="Transparency"
              desc="Clear communication and honest feedback at every step."
            />
            <ProcessStep
              number="02"
              title="Innovation"
              desc="Constantly exploring new technologies and design trends."
            />
            <ProcessStep
              number="03"
              title="Dedication"
              desc="Going above and beyond to ensure project success."
            />
            <ProcessStep
              number="04"
              title="Precision"
              desc="Meticulous attention to detail in design and code."
            />
          </div>
        </div>
        ...
        <div className="text-center">
          <h3 className="text-4xl md:text-7xl font-bold mb-16 tracking-tight font-heading">
            Let's Create{" "}
            <span className="font-display italic font-light text-[#C5A059]">
              Together.
            </span>
...
const ProcessStep = ({
  ...
  <div className="text-center relative group">
    ...
    <h3 className="text-2xl font-bold mb-4 relative z-10 text-white font-heading tracking-tight">
      {title}
    </h3>
    <p className="text-zinc-500 text-sm relative z-10 font-medium leading-relaxed tracking-tight">
      {desc}
    </p>
  </div>
);
