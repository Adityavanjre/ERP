...
const Order = () => {
  ...
  const renderStep1_Requirements = () => (
    ...
    >
      ...
      <div className="space-y-3">
        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 ml-1">
          Intelligence References (Optional)
        </label>
    ...
    >
      <div className="bg-zinc-900 border border-white/5 rounded-[2.5rem] p-10 md:p-16 relative overflow-hidden">
        ...
        <h3 className="text-2xl font-black mb-10 flex items-center gap-4 text-white">
          <CheckCircle className="text-indigo-400" size={28} /> Confirm
          Synchronization
        </h3>
        ...
        <div className="mt-12 pt-12 border-t border-white/5">
          <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 block mb-4">
            Mission Briefing
          </label>
      ...
      <div className="bg-indigo-500/5 border border-indigo-500/10 rounded-3xl p-8 flex gap-6 items-start">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm font-light leading-relaxed">
            Submitting these requirements initiates a 24-hour tactical review.
            If you choose to proceed with an advance, your project slot will be
            locked immediately.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-6">
        <label className="flex items-start gap-4 cursor-pointer group">
          ...
          <span className="text-xs text-gray-500 leading-relaxed group-hover:text-gray-400 transition-colors">
            I acknowledge the{" "}
            <span className="text-indigo-400 underline">Engagement Terms</span>{" "}
            and{" "}
            <span className="text-indigo-400 underline">Privacy Policy</span>.
            Payments are secured and governed by our refund structure.
          </span>
        </label>
      </div>
  ...
  const renderStep3_Payment = () => (
    ...
    >
      <div className="space-y-6">
        ...
        <h2 className="text-4xl md:text-6xl font-black italic font-serif">
          Mission Received.
        </h2>
        <p className="text-gray-400 text-xl font-light max-w-xl mx-auto">
          Your digital footprint has been established. Secure your slot in our
          development queue.
        </p>
      </div>
      ...
      <div className="max-w-md mx-auto relative group">
        ...
        <div className="relative bg-zinc-950 rounded-[2.5rem] p-10 md:p-12 border border-white/10 shadow-2xl overflow-hidden">
          <div className="mb-10 flex flex-col items-center">
            ...
            <h3 className="font-black text-xs uppercase tracking-[0.4em] text-gray-500">
              Secure Process
            </h3>
          </div>
          ...
          {showQRCode ? (
            ...
            <div className="space-y-10">
              <div className="p-10 bg-white/[0.03] border border-white/5 rounded-3xl">
                <div className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-500 mb-4">
                  Advance Commitment
                </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-24 gap-8">
          <div className="flex-1">
            <div className="inline-block px-4 py-2 rounded-full border border-indigo-500/20 bg-indigo-500/10 backdrop-blur-md mb-6">
              <span className="text-[10px] font-black tracking-[0.2em] text-indigo-300 uppercase">
                Step {step} of 3
              </span>
            </div>
          ...
          <div className="flex items-center gap-6">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center gap-4">
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center text-lg font-black transition-all duration-500 ${step === s ? "bg-indigo-600 text-white shadow-[0_0_30px_rgba(79,70,229,0.4)] border border-indigo-400" : step > s ? "bg-indigo-500/20 text-indigo-400 border border-indigo-500/30" : "bg-white/5 text-gray-700 border border-white/5"}`}
                >
                  {step > s ? <CheckCircle size={24} /> : s}
                </div>
                {s < 3 && (
                  <div
                    className={`hidden md:block w-8 h-px transition-all duration-700 ${step > s ? "bg-indigo-500" : "bg-white/10"}`}
                  />
                )}
              </div>
            ))}
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          ...
          <div className="space-y-10">
            ...
            <div className="pt-10 border-t border-white/5">
              <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 mb-6 font-sans">
                Strategic Partners
              </h4>
