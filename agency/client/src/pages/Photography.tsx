...
const albums = [
  {
    ...
    description:
      "Cinematic captures of love stories and traditional Indian heritage.",
    location: "Coastal Bharat",
    cover:
      "https://images.unsplash.com/photo-1621621667797-e06afc217fb0?q=80&w=1200",
    count: 12,
  },
  {
    id: "culture",
    ...
    description:
      "Architectural marvels and the deep soul of ancient Indian culture.",
    location: "Heritage Sites",
    cover:
      "https://images.unsplash.com/photo-1582510003544-4d00b7f5feee?q=80&w=1200",
    count: 15,
  },
  {
    id: "portrait",
    ...
    description:
      "Raw, authentic character studies of the people who define the landscape.",
    location: "Pan-India",
    cover:
...
const photoCollection = [
  {
    id: "w1",
    albumId: "wedding",
    url: "https://images.unsplash.com/photo-1621621667797-e06afc217fb0?q=80&w=1200",
    title: "Golden Union",
    location: "Chennai",
  },
  {
    id: "w2",
    albumId: "wedding",
    url: "https://images.unsplash.com/photo-1595521624438-2358bc7e64a1?q=80&w=1200",
    title: "Sacred Ritual",
    location: "Madurai",
  },
  {
    id: "w3",
    albumId: "wedding",
    url: "https://images.unsplash.com/photo-1605278077556-98dc427357c9?q=80&w=1200",
    title: "Eternal Garlands",
    location: "Kerala",
  },
  {
    id: "c1",
    albumId: "culture",
    url: "https://images.unsplash.com/photo-1582510003544-4d00b7f5feee?q=80&w=1200",
  ...
  },
  {
    id: "c2",
    albumId: "culture",
    url: "https://images.unsplash.com/photo-1591266014389-c45479532598?q=80&w=1200",
    title: "Lost Kingdom",
    location: "Hampi",
  },
  {
...
const Photography = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-white pt-48 pb-32">
      <SEO
        title="Photography | Klypso Agency"
        description="Professional high-end photography and cinematic production."
      />
            ...
            >
              <div className="text-center">
                ...
                <p className="max-w-2xl mx-auto text-xl text-zinc-500 font-medium underline underline-offset-4 decoration-[#C5A059]/20">
                  Crafting visual narratives with cinematic precision. We
                  capture moments that become timeless legacies.
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="px-4 pb-4">
                      <div className="flex justify-between items-end mb-4">
                        <h2 className="text-4xl font-bold font-heading group-hover:text-[#C5A059] transition-colors">
                          {album.title}
                        </h2>
                      ...
                      <p className="text-zinc-500 font-medium text-lg italic font-display mb-4">
                        {album.subtitle}
                      </p>
                ...
                {displayedPhotos.map((photo, index) => (
                  ...
                  >
                    ...
                    <div className="mt-8 flex justify-between items-center px-4">
                      <div>
                        <h3 className="text-sm font-bold text-white mb-1 font-heading uppercase tracking-widest">
                          {photo.title}
                        </h3>
          ...
          >
            <div className="absolute top-10 right-10 flex items-center gap-10">
              <div className="hidden lg:flex flex-col items-end">
                ...
                <span className="text-[9px] font-black text-[#C5A059] uppercase tracking-[0.4em]">
                  {displayedPhotos[lightboxIndex].location}
                </span>
              </div>
              <button
                onClick={closeLightbox}
                className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#C5A059] hover:text-black transition-all"
              >
                <X size={24} />
              </button>
            </div>
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-4 sm:gap-8 bg-black/40 backdrop-blur-2xl px-6 sm:px-10 py-5 rounded-full border border-white/10">
              ...
              <span className="text-[10px] sm:text-xs font-black text-white tracking-[0.3em]">
                {lightboxIndex + 1} / {displayedPhotos.length}
              </span>
              <div className="w-[1px] h-6 bg-white/10" />
              <button
