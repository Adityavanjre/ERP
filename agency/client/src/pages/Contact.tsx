  ...
  return (
    <section className="min-h-screen bg-[#0A0A0B] text-white pt-48 pb-32 px-4 relative overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with Klypso for high-end digital engineering and strategic design."
        />
      </Helmet>
          ...
          <div className="space-y-20">
            ...
            >
              ...
              <p className="max-w-md text-xl text-zinc-500 font-medium leading-relaxed">
                We're here to help you build something exceptional. Tell us
                about your vision and let's make it a reality.
              </p>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-10 relative z-10">
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <ArrowRight
                    size={16}
                    className="absolute right-6 top-1/2 -translate-y-1/2 text-zinc-600 pointer-events-none rotate-90"
                  />
                </div>
              </div>
...
const ContactLink = ({
  ...
  <div className="flex items-center gap-8 group">
    ...
    <div>
      <h4 className="text-[9px] font-black uppercase tracking-[0.5em] text-zinc-600 mb-2">
        {label}
      </h4>
      <a
        href={href}
        className="text-2xl font-bold text-white group-hover:text-[#C5A059] transition-colors tracking-tight font-heading"
      >
        {value}
      </a>
    </div>
