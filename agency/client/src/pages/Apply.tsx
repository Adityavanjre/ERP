  ...
  return (
    <section className="min-h-screen bg-[#0A0A0B] text-white pt-48 pb-32 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        <Link
          to="/careers"
          className="inline-flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 hover:text-[#C5A059] transition-colors mb-16"
        >
        ...
        <div className="text-center mb-24">
          ...
          <p className="max-w-xl mx-auto text-xl text-zinc-500 font-medium">
            Extraordinary talent is always welcome. Tell us about your craft and
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Paperclip
                    size={14}
                    className="absolute right-6 top-1/2 -translate-y-1/2 text-zinc-600 pointer-events-none"
                  />
                </div>
              </div>
              <div className="space-y-4">
              ...
              {status === "success" && (
                ...
                >
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest leading-loose">
                    Application Received. We will review your portfolio
                    carefully.
                  </p>
                </motion.div>
              )}
