...
const ProjectDetails = () => {
  ...
  if (error)
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-[#0A0A0B] text-white px-6">
        <h2 className="text-2xl font-bold mb-6 font-heading tracking-tight text-center">
          {error}
        </h2>
        <button
          onClick={handleRetry}
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-[#0A0A0B] text-white selection:bg-[#C5A059]/30 overflow-x-hidden"
    >
      <SEO
      ...
      <header className="relative h-screen flex items-end justify-start p-8 md:p-32 overflow-hidden">
        ...
        <motion.div style={{ opacity }} className="relative z-10 max-w-6xl">
          <Link
            to="/portfolio"
            className="inline-flex items-center gap-4 px-8 py-4 rounded-full bg-black/40 border border-white/10 text-zinc-500 hover:text-white mb-16 transition-all backdrop-blur-2xl group"
          >
            <ArrowLeft
              size={16}
          ...
          <div className="flex gap-4 mb-10">
            {project.categories?.map((cat: string) => (
              <span
                key={cat}
                className="text-[9px] font-black uppercase tracking-[0.4em] text-[#C5A059] bg-[#C5A059]/10 px-6 py-2 rounded-xl border border-[#C5A059]/20 backdrop-blur-md"
              >
                {cat}
              </span>
            ))}
        ...
        <div className="absolute bottom-20 right-20 hidden lg:flex items-center gap-10">
          <div className="text-right">
            <div className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-700 mb-2">
              Project Status
            </div>
            <div className="text-lg font-bold text-white tracking-widest uppercase font-heading">
              Case Study Live
            </div>
          </div>
      ...
      <main className="container mx-auto px-6 py-40 relative">
        <div className="grid lg:grid-cols-12 gap-32">
          <div className="lg:col-span-8 space-y-60">
            ...
            <section className="grid md:grid-cols-2 gap-16">
              <div className="premium-card p-16 group relative overflow-hidden">
                ...
                <h3 className="text-[10px] font-black mb-8 uppercase tracking-[0.4em] text-zinc-600">
                  The Challenge
                </h3>
                <p className="text-zinc-400 font-medium leading-relaxed text-lg">
                  {project.challenge ||
                    "Building a high-performance solution that aligns with the brand's vision and performance goals."}
                </p>
              </div>
              <div className="premium-card p-16 group relative overflow-hidden bg-[#121214]">
                ...
                <p className="text-zinc-400 font-medium leading-relaxed text-lg">
                  {project.solution ||
                    "Leveraging modern technologies to deliver a fast, secure, and intuitive user experience."}
                </p>
              </div>
            </section>
          ...
          <div className="lg:col-span-4 space-y-16">
            <RegistryCard
              icon={<Cpu className="text-[#C5A059]" />}
            ...
            >
              <div className="flex flex-wrap gap-2">
                {project.technologies?.map((tech: string) => (
                  <span
                    key={tech}
                    className="bg-black/40 border border-white/5 text-zinc-500 px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest hover:border-[#C5A059]/30 hover:text-white transition-all"
                  >
                    {tech}
                  </span>
                ))}
            ...
            {project.services && project.services.length > 0 && (
              <RegistryCard
                icon={<CheckCircle className="text-[#C5A059]" />}
              ...
              >
                <div className="space-y-4">
                  {project.services.map((service: string) => (
                    <div
                      key={service}
                      className="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500"
                    >
            ...
            {project.testimonial && (
              <div className="premium-card p-12 relative overflow-hidden">
                ...
                <p className="text-zinc-300 italic mb-10 relative z-10 font-display text-xl leading-relaxed">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <div className="text-sm font-bold uppercase tracking-[0.2em] text-white font-heading">
                      {project.testimonial.author}
                    </div>
                    <div className="text-[9px] uppercase tracking-[0.4em] text-[#C5A059] font-black mt-1">
      ...
      <section className="py-60 border-t border-white/5 bg-black overflow-hidden relative text-center">
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <h2 className="text-5xl md:text-[10rem] font-bold mb-16 tracking-tight leading-none font-heading">
            Start Your <br />
            <span className="font-display italic font-light text-[#C5A059]">
              Legacy.
            </span>
...
const RegistryCard = ({
  ...
  <div className="premium-card p-12 space-y-8 bg-[#121214]">
    <div className="flex items-center gap-4 border-b border-white/5 pb-8">
      ...
      <h3 className="font-black text-[10px] uppercase tracking-[0.5em] text-zinc-600">
        {title}
      </h3>
    </div>
    <div>{children}</div>
